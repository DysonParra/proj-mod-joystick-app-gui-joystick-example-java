 ...
 * @since 11
 */
public class NintendoJoystickComponentActionSetter extends GenericJoystickComponentActionSetter<ExampleFrame, JLabel> {
     ...
     *                       alto).
     */
    public NintendoJoystickComponentActionSetter(JLabel component, ExampleFrame window, int windowWidth, int windowHeight, int windowDivision) {
